...
import { AccountLimitPageViewComponent } from './account-limit-page.component';
...
describe('AccountPageComponent ', () => {
  ...
  const presentActionSheetChooseAction = async (
    role: any,
    component: AccountLimitPageViewComponent,
    spyMethod: keyof AccountLimitPageViewComponent
  ) => {
    const htmlAction: HTMLIonActionSheetElement = {
      present: (): Promise<void> => {
        return new Promise<void>((resolve, reject) => {
  ...
  describe('AccountPageComponent mode account', () => {
    let component: AccountLimitPageViewComponent;
    let fixture: ComponentFixture<AccountLimitPageViewComponent>;
    ...
    beforeEach(waitForAsync(() => {
      TestBed.configureTestingModule({
        declarations: [AccountLimitPageViewComponent],
      ...
      fixture = TestBed.createComponent(AccountLimitPageViewComponent);
